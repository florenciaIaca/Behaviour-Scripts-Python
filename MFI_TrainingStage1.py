...
# 2AC Visual task
# Training stage 1: Same as stage 0 but without a free reward at the start of every trial. Reward is only given if the animal licks the correct spout.
# The stimulus lasts until the mouse licks the correct spout and collects the reward. Mice are expected to achieve 1 block of 50 trails.
