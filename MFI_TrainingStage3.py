...
# 2AC Visual task
# Training stage 3: A “punishment” is introduced whereby an incorrect lick triggers a flickering whie and black screen and triggers a delay of 20 seconds before the repetition of the same stimulus.
# After an incorrect trial, the following trial has the same stimulus as the previous trial, to prevent bias towards one side.
...
print 'Running Training stage 3 Visual Task'
