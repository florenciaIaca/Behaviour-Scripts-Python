...
# 2AC Visual task
# Training stage 5: A delay of ~1to2 seconds is introduced (by delaying the sound go signal) before the reward is delivered.

# Author: Maria Florencia Iacaruso
# contact: florencia.iacaruso@gmail.com

print 'Running Training stage 5 Visual Task'
