# 2AC Auditory and visual task training stage 4
# Trail starts with a sound/LED light that is presented for 100 ms. If the correct spout is licked there is a reward,
# otherwise a punishement of 20 seconds out is introduced. The animal will have to wait 3 seconds to start licking to get a reward. Otherwise the trial will start again.
# Author: Maria Florencia Iacaruso
# contact: florencia.iacaruso@gmail.com

print 'Running Training stage 4 Sound and visual in blocks of 10'
...
nRews = 0
maxRews = 4 ; # number of rewards for visual or auditory blocks
nBlocks=2; # number of blocks
maxRews3=maxRews*nBlocks*2; # total number of rewards
