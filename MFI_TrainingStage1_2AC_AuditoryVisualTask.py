# 2AC Auditory and visual task training stage 1
...
# If the animal licks the wrong side 5 times, there will be a reward deliuvered on the opposite side
# Visual and auditory blocls are interleaved. 100 trails in the first session
# Author: Maria Florencia Iacaruso
# contact: florencia.iacaruso@gmail.com

print 'Running Training stage 1 Sound and visual in blocks of 50'
...
Training = True
maxRews = 50 ; # Maximum number of rewards per block  
